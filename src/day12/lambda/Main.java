...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("========== 노랑색이면서 가벼운 사과 필터링 ==========");
		List<Apple> apples4 = filterApples(appleBasket, new ApplePredicate() {
			@Override
			public boolean test(Apple apple) {
				return apple.getColor() == YELLOW && apple.getWeight() < 100;
			}
		});
		...
		List<Color> colors = MappingApple.mappingAPllesByColor(appleBasket);
