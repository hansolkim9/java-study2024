...
//			fos = new FileOutputStream(FileExample.ROOT_PATH + "/hello2/pet.txt");
		...
		/*
		finally { // 예외가 나도 실행, 안나도 실행되는 코
//			System.out.println("이 코드는 무조건 실행됨!");

			// 파일 입출력과 같은 코드는 하드웨어에 직접 접근하는 코드이므로
			// 보통 사용 후 메모리 정리를 해줘야 다음 실행에 문제가 생길 여지가 줄어든다.
			try {
